...
SSES_fit <- es(ts_load_daily_avg_train,model="MAM",h=365,holdout=FALSE,silent="none")
plot(SSES_fit)
```
...
```{r Forecast3}
#SS Exponential Smoothing
SSES_for <- es(ts_load_daily_avg,model="MMA",h=31,holdout=FALSE,silent="none")
plot(SSES_for)

#Convert forecasting results to dataframe
Forecast3 <- data.frame(load = SSES_for)
```
