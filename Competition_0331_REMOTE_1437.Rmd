...
ts_load_daily_avg_rm_na<-msts(load_data_rm_na,seasonal.periods =c(7,365.25),start=c(2005,01,01)) #convert to time series
ts_load_daily_avg_rm_na <- ts(ts_load_daily_avg_rm_na)
...
SSES_for <- es(ts_load_daily_avg_rm_na,model="ZZZ",h=31,holdout=FALSE,silent="none")
plot(SSES_for)
```
